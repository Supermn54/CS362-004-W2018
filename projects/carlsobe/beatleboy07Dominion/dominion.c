...
/*****************************************************************************************************
 * Clifford Dunn: Functions added to the game
*****************************************************************************************************/
...
int Adventurer(int currentPlayer, struct gameState* state)
{
    ...
    {
        // If the deck is empty, we need to shuffle the discard pile and add to the deck
        ...
        // The top card of the hand is the most recently drawn card
        ...
        if(cardDrawn = copper || cardDrawn == silver || cardDrawn == gold)
            ...
            // Remove the most recently drawn card;
    ...
    while(z-1 >= 0) {
        // Discard all newly drawn cards that are in play
...
int Ambassador(int currentPlayer, struct gameState* state, int choice1, int choice2, int handPos)
{
...
int Embargo(int currentPlayer, struct gameState* state, int choice1, int handPos)
{
    // Add 2 coins
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case village:
      return Village(currentPlayer, state, handPos);
    ...
    case embargo: 
      return Embargo(currentPlayer, state, handPos, choice1);
