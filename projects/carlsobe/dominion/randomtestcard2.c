...
int main() {
  ...
  int addActions = 1;
  int discardAction = 1;
  int testH1 = 0, testH2 = 0, testD1 = 0, testD2 = 0, testA1 = 0, testA2 = 0;
  ...
  for (x = 0; x < n; x++){
	...
	G.numActions = (rand() % 118); //number of theoretical actions
	...
	if(testH1 == testH2 && testD1 == testD2 && testA1 == testA2){
