...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
       adventurerRef(currentPlayer, state);
       break;
    ...
    case steward:
	stewardRef(currentPlayer, state, choice1, choice2, choice3, handPos);
	break;
    ...
    case embargo: 
	embargoRef(currentPlayer, state, choice1, handPos);
	break;
...
int stewardRef(int currentPlayer, struct gameState *state, int choice1, int choice2, int choice3, int handPos)
{
      ...
      if (choice1 == 1)
	{
      ...
      else if (choice1 == 1) //BUG: changed choice1 value from 2 to 1
	{
	  //+2 coins
	  state->coins = state->coins + 2;
	}
...
int embargoRef(int currentPlayer, struct gameState *state, int handPos, int choice1)
{
      ...
      if ( state->supplyCount[choice1] == -1 )
	{
      ...
      //trash card...BUG: No card discard.
      //discardCard(handPos, currentPlayer, state, 1);		
      return 0;
}
